		...
		<footer class="pr-footer uk-background-muted uk-section uk-section-xsmall">
			...
			<div class="pr-footer-below">
				<div class="uk-container uk-text-center">
					<p><a href="https://creativecommons.org/licenses/by/4.0/" style="color:#000000"><i class="fab fa-creative-commons"></i><i class="fab fa-creative-commons-by"></i></a> {{trainerName}}<br>Frameworked by <a href="https://github.com/michaelravedoni/prathletics">Prathletics</a> (2018) — <a class="" href="/about">About</a></p>
				</div>
			</div>
		</footer>
	</div>
